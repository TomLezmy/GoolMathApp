...
//        SubCategoryAdapter subCategoryAdapter = new SubCategoryAdapter(subCategories, cardColorId);
...
//        // Send back to the relevant activity,
////        callback.onSelectedSubCategory(this.currentCategoryIndex, subCategoryId);
//        Toast.makeText(getContext(), "sub_categores="+ subCategoryId,Toast.LENGTH_SHORT).show();
//        callback.onSelectedSubCategory(this.currentCategoryIndex,subCategoryId);
//
//
//    }
